...
('brief', '간략한', 'business', 'SILVER', NOW()),
('buyer', '구매자', 'business', 'BRONZE', NOW()),
('cable', '케이블', 'business', 'BRONZE', NOW()),
('claim', '주장하다', 'business', 'SILVER', NOW()),
('clash', '충돌하다', 'business', 'GOLD', NOW()),
('clean', '청결한', 'daily', 'BRONZE', NOW()),
('clear', '명확한', 'business', 'BRONZE', NOW()),
('clerk', '직원', 'hr', 'BRONZE', NOW()),
('clock', '시계', 'daily', 'BRONZE', NOW()),
('close', '마감하다', 'business', 'BRONZE', NOW()),
('coach', '코치하다', 'hr', 'SILVER', NOW()),
('costs', '비용', 'economy', 'BRONZE', NOW()),
('court', '법원', 'hr', 'GOLD', NOW()),
('cover', '보장하다', 'business', 'SILVER', NOW()),
('craft', '기술', 'business', 'SILVER', NOW()),
('crane', '크레인', 'business', 'SILVER', NOW()),
('crash', '충돌', 'business', 'SILVER', NOW()),
('debug', '디버그하다', 'business', 'GOLD', NOW()),
('delay', '지연', 'travel', 'BRONZE', NOW()),
('depot', '창고', 'business', 'GOLD', NOW()),
('draft', '초안', 'business', 'SILVER', NOW()),
('drive', '추진하다', 'business', 'BRONZE', NOW()),
('email', '이메일', 'business', 'BRONZE', NOW()),
('entry', '입력', 'business', 'BRONZE', NOW()),
('equal', '동등한', 'hr', 'SILVER', NOW()),
('error', '오류', 'business', 'BRONZE', NOW()),
('event', '행사', 'marketing', 'BRONZE', NOW()),
('extra', '추가의', 'business', 'BRONZE', NOW()),
('fault', '결함', 'business', 'SILVER', NOW()),
('field', '분야', 'business', 'BRONZE', NOW()),
('final', '최종의', 'business', 'BRONZE', NOW()),
('fixed', '고정된', 'economy', 'SILVER', NOW()),
('floor', '층', 'business', 'BRONZE', NOW()),
('focus', '집중하다', 'business', 'BRONZE', NOW()),
('funds', '자금', 'economy', 'SILVER', NOW()),
('grant', '승인하다', 'business', 'GOLD', NOW()),
('graph', '그래프', 'business', 'BRONZE', NOW()),
('group', '그룹', 'business', 'BRONZE', NOW()),
('guest', '손님', 'travel', 'BRONZE', NOW()),
('guide', '안내하다', 'travel', 'BRONZE', NOW()),
('hired', '고용된', 'hr', 'BRONZE', NOW()),
('hours', '근무시간', 'hr', 'BRONZE', NOW()),
('ideal', '이상적인', 'business', 'SILVER', NOW()),
('image', '이미지', 'marketing', 'BRONZE', NOW()),
('input', '입력', 'business', 'BRONZE', NOW()),
('issue', '문제', 'business', 'BRONZE', NOW()),
('items', '항목', 'business', 'BRONZE', NOW());
